...
namespace CoreTemplate.App.Db.Migrations
{
    ...
    [Migration("20210210112654_AppTablesInitialMigration")]
    partial class AppTablesInitialMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreTemplate.App.Db.Tables.ChartOfAccount", b =>
                {
            ...
            modelBuilder.Entity("CoreTemplate.App.Db.Tables.VoucherType", b =>
                {
                    b.Property<int>("VoucherTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreTemplate.App.Db.Tables.ChartOfAccount", b =>
                {
                    b.HasOne("CoreTemplate.App.Db.Tables.AccountNature", "AccountNature")
            ...
            modelBuilder.Entity("CoreTemplate.App.Db.Tables.GeneralLedger", b =>
                {
                    ...
                    b.HasOne("CoreTemplate.App.Db.Tables.Voucher", "Voucher")
                        .WithMany()
                        .HasForeignKey("VoucherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
